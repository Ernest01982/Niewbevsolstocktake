...
This matrix separates tests automated through Phase 4 from mandatory later-phase coverage. A later-phase row is not marked passed merely because its table or workflow does not yet exist.

## Phase 0 through Phase 4 automated tests
